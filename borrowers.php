		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Senarai Pegawai ABT (Penghutang)</b>
				</large>
				<button class="btn btn-primary btn-block col-md-2 float-right" type="button" id="new_borrower"><i class="fa fa-plus"></i> Daftar Penghutang</button>
			</div>
			<div class="card-body">
				<table class="table table-bordered" id="borrower-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">ABT Terkini</th>
