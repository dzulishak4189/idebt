		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Senarai ABT JKDM LTA KL</b>
					<button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button" id="new_application"><i class="fa fa-plus"></i> Daftar ABT Baharu</button>
				</large>
				...
				<table class="table table-bordered" id="loan-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">Penghutang</th>
							<th class="text-center">Jenis ABT </th>
							<th class="text-center">Jadual Pembayaran ABT</th>
