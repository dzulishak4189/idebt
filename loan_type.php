				...
				<div class="card">
					...
					<div class="card-body">
							...
							<div class="form-group">
								<label class="control-label">Jenis ABT</label>
								<textarea name="type_name" id="" cols="30" rows="2" class="form-control"></textarea>
							</div>
							<div class="form-group">
								<label class="control-label">Deskripsi ABT</label>
						...
						<table class="table table-bordered table-hover">
							...
							<tbody>
								...
								<tr>
									...
									<td class="">
										 <p>Jenis ABT: <b><?php echo $row['type_name'] ?></b></p>
										 <p><small>Deskripsi: <b><?php echo $row['description'] ?></b></small></p>
									</td>
