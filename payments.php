		...
		<div class="card">
			<div class="card-header">
				<large class="card-title">
					<b>Senarai Bayaran ABT Pegawai</b>
					<button class="btn btn-primary btn-sm btn-block col-md-2 float-right" type="button" id="new_payments"><i class="fa fa-plus"></i> Bayaran Baharu</button>
				</large>
				...
				<table class="table table-bordered" id="loan-list">
					...
					<thead>
						<tr>
							...
							<th class="text-center">No. Surat Rujukan ABT</th>
