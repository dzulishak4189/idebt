...
<head>
  ...
  <title>Login | Sistem i-DEBT 2.0 </title>
		...
		$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
			...
			success:function(resp){
				if(resp == 1){
					...
					$('#login-form').prepend('<div class="alert alert-danger">ID Pengguna Atau Kata Laluan Tidak Tepat, Sila Semak Semula !</div>')
					$('#login-form button[type="button"]').removeAttr('disabled').html('Login');
				}
			}
		})
